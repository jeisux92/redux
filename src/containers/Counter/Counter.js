  ...
  render() {
    return (
      <div>
        ...
        <CounterControl
          label="Increment"
          clicked={this.props.onIncrementerCounter}
        />
        <CounterControl
          label="Decrement"
          clicked={this.props.onDecrementerCounter}
        />
        <CounterControl
          label="Add 5"
        ...
        <ul>
          {this.props.rslts.map((rst, id) => (
            <li onClick={() => this.props.onDeleteResult(id)} key={id}>
              {rst}
            </li>
          ))}
        </ul>
